...
def stanley_control(state, cx, cy, cyaw, last_target_idx, lane_current_curvature, is_at_solid_line, error_d):
    ...
    if average_curvature < 0.004:
        ...
        k_curvature = 65
    delta = k_theta_ * theta_e + k_d * theta_d + k_curvature * average_curvature
    # max--0.005
    ...
    if not is_at_solid_line and math.fabs(theta_e) < 0.12:
        if delta >= deg_to_rad(30):
            delta = deg_to_rad(30)
        elif delta <= -deg_to_rad(30):
            delta = -deg_to_rad(30)
    if is_at_solid_line and average_curvature != 0:
        delta *= 1.5
...
x_uni = np.linspace(20, 180, 9)
y_uni = [0.1240, 0.1145, 0.1205, 0.1475, 0.1745, 0.2195, 0.3105, 0.4085, 0.5205]
x_th, y_th = np.mgrid[0:1:11j, 0:180:10j]
z_th = [[1.9730, -0.7466, -0.3934, -0.3420, -0.4822, -0.6413, -0.8234, -1.0316, -1.2710, -1.5333],
        [2.1454, -0.5067, -0.2101, -0.2111, -0.3834, -0.5642, -0.7601, -0.9807, -1.2261, -1.4944],
        [3.6572,  1.8343,  1.4560,  0.9574,  0.5727,  0.2392, -0.0820, -0.3989, -0.7206, -1.0421],
        [3.7796,  2.9935,  2.1136,  1.3881,  1.0263,  0.6868,  0.3288, -0.0362, -0.4009, -0.7632],
        [3.8177,  3.8622,  2.7008,  1.7739,  1.4233,  1.0673,  0.7387,  0.3495, -0.0325, -0.4286],
        [3.8177,  4.2992,  3.1524,  2.3269,  1.7783,  1.4070,  1.1328,  0.7880,  0.3768, -0.0469],
        [3.8177,  4.5076,  3.3241,  2.4839,  1.9103,  1.5453,  1.3129,  1.0139,  0.6050,  0.1691],
        [3.8177,  4.6816,  4.1868,  3.0012,  2.2289,  1.6911,  1.5128,  1.2380,  0.8452,  0.3835],
        [3.8177,  4.7295,  4.2352,  3.0626,  2.8261,  2.1037,  1.5675,  1.3028,  0.9166,  0.4477],
        [3.8177,  4.7696,  4.2537,  3.1145,  2.9018,  2.1636,  1.6130,  1.3555,  0.9758,  0.5020],
        [3.8177,  4.7892,  4.2542,  3.1507,  2.9570,  2.2059,  1.6462,  1.3976,  1.0194,  0.5417],
        ] # 节气门标定表
x_br, y_br = np.mgrid[0:15:16j, 0:180:10j]
z_br = [[ -0.0503,  -0.7466,  -0.3934,  -0.3420,  -0.4822,  -0.6413,  -0.8234,  -1.0316,  -1.2710,  -1.5333],
        [ -1.5165,  -2.1053,  -2.3524,  -2.4023,  -2.5396,  -2.6935,  -2.8686,  -3.0654,  -3.2974,  -3.5543],
        [ -2.9879,  -3.4409,  -4.3118,  -4.4455,  -4.5778,  -4.7261,  -4.8948,  -5.0812,  -5.3120,  -5.5679],
        [ -4.1143,  -4.3511,  -5.7410,  -6.2246,  -6.0613,  -6.1647,  -6.3235,  -6.5657,  -6.7799,  -7.0238],
        [ -5.2906,  -5.2770,  -7.1214,  -7.4565,  -7.5685,  -7.6996,  -7.8637,  -8.0526,  -8.2643,  -8.5002],
        [ -6.6704,  -6.2952,  -8.6877,  -8.9886,  -9.1028,  -9.2361,  -9.3857,  -9.5767,  -9.7867, -10.0190],
        [ -8.0940,  -7.3411, -10.1128, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [ -9.4772,  -8.1753, -10.1739, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571,  -8.9192, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571,  -9.2036, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571,  -9.6282, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571,  -9.8832, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571, -10.0302, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571, -10.0302, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571, -10.0302, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        [-10.6571, -10.0302, -10.1764, -10.4433, -10.5372, -10.6693, -10.8235, -10.9971, -11.2226, -11.4460],
        ] # 刹车主缸压力标定表
